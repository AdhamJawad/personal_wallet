...
mixin _$Contact {
 ...
 String get id; String get ownerUserId; ContactKind get kind; ContactEntityType get entityType; String get name; String? get phoneNumber; String? get emailAddress; String? get note; String? get imageUri; String? get linkedUserId; FutureLinkCandidate? get futureLinkCandidate;@DateTimeConverter() DateTime get createdAt;@DateTimeConverter() DateTime get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,ownerUserId,kind,entityType,name,phoneNumber,emailAddress,note,imageUri,linkedUserId,futureLinkCandidate,createdAt,updatedAt);

@override
String toString() {
  return 'Contact(id: $id, ownerUserId: $ownerUserId, kind: $kind, entityType: $entityType, name: $name, phoneNumber: $phoneNumber, emailAddress: $emailAddress, note: $note, imageUri: $imageUri, linkedUserId: $linkedUserId, futureLinkCandidate: $futureLinkCandidate, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String ownerUserId, ContactKind kind, ContactEntityType entityType, String name, String? phoneNumber, String? emailAddress, String? note, String? imageUri, String? linkedUserId, FutureLinkCandidate? futureLinkCandidate,@DateTimeConverter() DateTime createdAt,@DateTimeConverter() DateTime updatedAt
});
...
/// Create a copy of Contact
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? ownerUserId = null,Object? kind = null,Object? entityType = null,Object? name = null,Object? phoneNumber = freezed,Object? emailAddress = freezed,Object? note = freezed,Object? imageUri = freezed,Object? linkedUserId = freezed,Object? futureLinkCandidate = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
...
as ContactKind,entityType: null == entityType ? _self.entityType : entityType // ignore: cast_nullable_to_non_nullable
as ContactEntityType,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String ownerUserId,  ContactKind kind,  ContactEntityType entityType,  String name,  String? phoneNumber,  String? emailAddress,  String? note,  String? imageUri,  String? linkedUserId,  FutureLinkCandidate? futureLinkCandidate, @DateTimeConverter()  DateTime createdAt, @DateTimeConverter()  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Contact() when $default != null:
return $default(_that.id,_that.ownerUserId,_that.kind,_that.entityType,_that.name,_that.phoneNumber,_that.emailAddress,_that.note,_that.imageUri,_that.linkedUserId,_that.futureLinkCandidate,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
class _Contact implements Contact {
  const _Contact({required this.id, required this.ownerUserId, required this.kind, this.entityType = ContactEntityType.person, required this.name, this.phoneNumber, this.emailAddress, this.note, this.imageUri, this.linkedUserId, this.futureLinkCandidate, @DateTimeConverter() required this.createdAt, @DateTimeConverter() required this.updatedAt});
...
@override@JsonKey() final  ContactEntityType entityType;
...
/// Create a copy of Contact
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? ownerUserId = null,Object? kind = null,Object? entityType = null,Object? name = null,Object? phoneNumber = freezed,Object? emailAddress = freezed,Object? note = freezed,Object? imageUri = freezed,Object? linkedUserId = freezed,Object? futureLinkCandidate = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
