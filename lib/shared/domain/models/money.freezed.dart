...
mixin _$Money {
 ...
 Currency get currency; String get amount;
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Currency currency,  String amount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Money() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Currency currency,  String amount)  $default,) {final _that = this;
switch (_that) {
case _Money():
return $default(_that.currency,_that.amount);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Currency currency,  String amount)?  $default,) {final _that = this;
switch (_that) {
case _Money() when $default != null:
return $default(_that.currency,_that.amount);case _:
  return null;
