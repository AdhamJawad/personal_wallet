...
mixin _$NotificationItem {
 ...
 String get id; String get ownerUserId; NotificationType get type; String get title; String get message; String? get relatedEntityId; String? get relatedEntityType; bool get isRead;@DateTimeConverter() DateTime? get readAt;@DateTimeConverter() DateTime get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,ownerUserId,type,title,message,relatedEntityId,relatedEntityType,isRead,readAt,createdAt);

@override
String toString() {
  return 'NotificationItem(id: $id, ownerUserId: $ownerUserId, type: $type, title: $title, message: $message, relatedEntityId: $relatedEntityId, relatedEntityType: $relatedEntityType, isRead: $isRead, readAt: $readAt, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String ownerUserId, NotificationType type, String title, String message, String? relatedEntityId, String? relatedEntityType, bool isRead,@DateTimeConverter() DateTime? readAt,@DateTimeConverter() DateTime createdAt
});
...
/// Create a copy of NotificationItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? ownerUserId = null,Object? type = null,Object? title = null,Object? message = null,Object? relatedEntityId = freezed,Object? relatedEntityType = freezed,Object? isRead = null,Object? readAt = freezed,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String ownerUserId,  NotificationType type,  String title,  String message,  String? relatedEntityId,  String? relatedEntityType,  bool isRead, @DateTimeConverter()  DateTime? readAt, @DateTimeConverter()  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NotificationItem() when $default != null:
return $default(_that.id,_that.ownerUserId,_that.type,_that.title,_that.message,_that.relatedEntityId,_that.relatedEntityType,_that.isRead,_that.readAt,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String ownerUserId,  NotificationType type,  String title,  String message,  String? relatedEntityId,  String? relatedEntityType,  bool isRead, @DateTimeConverter()  DateTime? readAt, @DateTimeConverter()  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _NotificationItem():
return $default(_that.id,_that.ownerUserId,_that.type,_that.title,_that.message,_that.relatedEntityId,_that.relatedEntityType,_that.isRead,_that.readAt,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
class _NotificationItem implements NotificationItem {
  const _NotificationItem({required this.id, required this.ownerUserId, required this.type, required this.title, required this.message, this.relatedEntityId, this.relatedEntityType, this.isRead = false, @DateTimeConverter() this.readAt, @DateTimeConverter() required this.createdAt});
...
@override@DateTimeConverter() final  DateTime? readAt;
...
/// Create a copy of NotificationItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? ownerUserId = null,Object? type = null,Object? title = null,Object? message = null,Object? relatedEntityId = freezed,Object? relatedEntityType = freezed,Object? isRead = null,Object? readAt = freezed,Object? createdAt = null,}) {
