...
mixin _$RegisterRequest {
 ...
 String get fullName; String get phoneNumber; String get password;
...
@useResult
$Res call({
 String fullName, String phoneNumber, String password
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String fullName,  String phoneNumber,  String password)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RegisterRequest() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String fullName,  String phoneNumber,  String password)  $default,) {final _that = this;
switch (_that) {
case _RegisterRequest():
return $default(_that.fullName,_that.phoneNumber,_that.password);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String fullName,  String phoneNumber,  String password)?  $default,) {final _that = this;
switch (_that) {
case _RegisterRequest() when $default != null:
return $default(_that.fullName,_that.phoneNumber,_that.password);case _:
  return null;
...
class _RegisterRequest implements RegisterRequest {
  const _RegisterRequest({required this.fullName, required this.phoneNumber, required this.password});
